  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
            ...
            >
              ...
              <div 
                ...
                style={{
                  ...
                  top: isSad ? `${100 + (yellowPos.faceY || 0)}px` : (password.length > 0 && showPassword) ? `${88}px` : `${88 + (yellowPos.faceY || 0)}px`,
      ...
      <div className="flex items-center justify-center p-8 bg-background relative">
        ...
        <div className="w-full max-w-[420px] mt-12 sm:mt-0">
          {/* Mobile Logo */}
          ...
          <div className="text-center mb-10">
            <h1 className="text-3xl font-black tracking-tighter mb-2 uppercase italic underline decoration-blue-500 underline-offset-8">Welcome back!</h1>
            <p className="text-muted-foreground text-sm font-medium mt-4">Discover India like never before.</p>
          </div>
          ...
          <form onSubmit={onSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              <Label htmlFor="password" className="text-xs font-black tracking-widest uppercase text-gray-400">Secret Password</Label>
            ...
            <div className="flex items-center justify-between">
              ...
              <a
                href="#"
                className="text-xs text-blue-600 hover:text-blue-700 font-black tracking-wide uppercase italic"
              >
                Forgot?
              </a>
            </div>
          ...
          <div className="text-center text-sm text-muted-foreground mt-8 p-6 rounded-2xl bg-gray-50/50">
            New traveler?{" "}
            <a href="/signup" className="text-blue-600 font-black hover:underline uppercase italic">
              Create account
            </a>
          </div>
        </div>
